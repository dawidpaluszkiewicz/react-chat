...
export const findDefaultIntent = (language, name) => { var _a; return (_a = DEFAULT_INTENTS_MAP === null || DEFAULT_INTENTS_MAP === void 0 ? void 0 : DEFAULT_INTENTS_MAP[language]) === null || _a === void 0 ? void 0 : _a.find((intent) => intent.name === name); };
export const DEFAULT_INTENTS_MAP = {
