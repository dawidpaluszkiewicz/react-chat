...
export interface Model<_PlatformData extends PlatformData, Command extends BaseCommand = BaseCommand, Locale extends string = string, SurveyContextExt extends AnyRecord = AnyRecord> {
    _id: string;
    _version?: number;
    creatorID: number;
    projectID: string;
