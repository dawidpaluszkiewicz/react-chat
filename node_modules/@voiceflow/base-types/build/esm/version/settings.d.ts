...
export declare const defaultSettings: <Prompt>({ error, repeat, session, defaultCanvasNodeVisibility, defaultCarouselLayout, globalNoMatch, globalNoReply, intentConfidence, }?: Partial<Settings<Prompt>>) => Settings<Prompt>;
