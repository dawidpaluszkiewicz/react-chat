...
describe('deep clone integers, strings and booleans', function () {
    it('clones integers', function () {
        eq((0, clone_1.clone)(-4), -4);
        eq((0, clone_1.clone)(9007199254740991), 9007199254740991);
    });
    it('clones floats', function () {
        eq((0, clone_1.clone)(-4.5), -4.5);
        eq((0, clone_1.clone)(0.0), 0.0);
    });
    it('clones strings', function () {
        eq((0, clone_1.clone)('foo'), 'foo');
    });
    it('clones booleans', function () {
        eq((0, clone_1.clone)(true), true);
    });
});
describe('deep clone objects', function () {
    it('clones shallow object', function () {
        var obj = { a: 1, b: 'foo', c: true, d: new Date(2013, 11, 25) };
        var cloned = (0, clone_1.clone)(obj);
        obj.c = false;
        obj.d.setDate(31);
...
describe('deep clone arrays', function () {
    it('clones shallow arrays', function () {
        var list = [1, 2, 3];
        var cloned = (0, clone_1.clone)(list);
        list.pop();
        eq(cloned, [1, 2, 3]);
    });
...
describe('built-in types', function () {
    it('clones Date object', function () {
        ...
        var cloned = (0, clone_1.clone)(date);
    ...
    it('clones RegExp object', function () {
        [/x/, /x/g, /x/i, /x/m, /x/gi, /x/gm, /x/im, /x/gim].forEach(function (pattern) {
            var cloned = (0, clone_1.clone)(pattern);
...
describe('deep clone edge cases', function () {
    it('nulls, undefineds and empty objects and arrays', function () {
        eq((0, clone_1.clone)(null), null);
        eq((0, clone_1.clone)(undefined), undefined);
        assert.notStrictEqual((0, clone_1.clone)(undefined), null);
        var obj = {};
        assert.notStrictEqual((0, clone_1.clone)(obj), obj);
        var list = [];
        assert.notStrictEqual((0, clone_1.clone)(list), list);
    });
});
