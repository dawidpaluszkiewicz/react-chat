...
describe('pipe', function () {
    test('flatten multiple values', function () {
        var result = (0, pipe_1.pipe)([[1, 2], 3, [4, 5]], (0, flatten_1.flatten)());
        expect(result).toEqual([1, 2, 3, 4, 5]);
    });
    test('flatten single value', function () {
        var result = (0, pipe_1.pipe)([[1]], (0, flatten_1.flatten)());
        expect(result).toEqual([1]);
    });
    test('with find', function () {
        var counter1 = (0, _counter_1.createCounter)();
        var counter2 = (0, _counter_1.createCounter)();
        var result = (0, pipe_1.pipe)([[1, 2], 3, [4, 5]], counter1.fn(), (0, flatten_1.flatten)(), counter2.fn(), (0, find_1.find)(function (x) { return x - 1 === 2; }));
