...
describe('data_first', function () {
    it('filter', function () {
        var result = (0, filter_1.filter)([1, 2, 3], function (x) { return x % 2 === 1; });
        assertType(result); // Type test
        expect(result).toEqual([1, 3]);
    });
    it('data_first with typescript guard', function () {
        var result = (0, filter_1.filter)([1, 2, 3, 'abc', true], isNumber);
        assertType(result); // Type test
...
describe('data_last', function () {
    it('filter', function () {
        ...
        var result = (0, pipe_1.pipe)([1, 2, 3], (0, filter_1.filter)(function (x) { return x % 2 === 1; }), counter.fn());
    ...
    it('filter with typescript guard', function () {
        var counter = (0, _counter_1.createCounter)();
        var result = (0, pipe_1.pipe)([1, 2, 3, false, 'text'], // Type (1 | 2 | 3 | false | "text")[]
        (0, filter_1.filter)(isNumber), counter.fn());
    ...
    it('filter.indexed', function () {
        var counter = (0, _counter_1.createCounter)();
        var result = (0, pipe_1.pipe)([1, 2, 3], filter_1.filter.indexed(function (x, i) { return x % 2 === 1 && i !== 1; }), counter.fn());
        assertType(result); // Type test (1 | 2 | 3)[]
        expect(counter.count).toHaveBeenCalledTimes(2);
        expect(result).toEqual([1, 3]);
    });
